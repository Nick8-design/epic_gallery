...
class Dashboard extends StatefulWidget {
  @override
  State<Dashboard> createState() => _PhotoScreenState();
}

class _PhotoScreenState extends State<Dashboard> {

  final TextEditingController searchControler = TextEditingController();
  final ScrollController _scrollController = ScrollController();
  List<Wallpaper> _wallpapers = [];
  String selectedCategory = 'cities';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: photofloat(),
      body:
...
Widget walls(int col, ScrollController scrollController, BuildContext context,List<Wallpaper> wallpapers){
